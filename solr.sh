...
touch $DIRECTORY/$1/bin/appenv.sh
chmod +x $DIRECTORY/$1/bin/appenv.sh
echo export JAVA_OPTS=\"\$JAVA_OPTS -Dsolr.solr.home=/opt/dev/solr-index\" > $DIRECTORY/$1/bin/appenv.sh
